...
function Chome(){
    return(
        ...
        <div class="i-titulo-sec">
            ...
            <h4>"Añade color y arte a tu vida"</h4>
        </div>
    ...
    <section>
        <div class="i-titulo-sec">
            ...
            <h4>"Un buen artista siempre usa las mejores herramientas"</h4>
        </div>
    ...
    <section>
        <div class="i-titulo-sec">
            ...
            <h4>"El aprendizaje continuo es el camino al éxito"</h4>
        </div>
        ...
        <section>
            <div class="i-titulo-sec">
                ...
                <h4>"Conoce un poco de nuestro trabajo"</h4>
            </div>
            <div class="i-video">
